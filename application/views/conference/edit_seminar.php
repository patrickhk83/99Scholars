		...
		<div class="col-xs- col-sm-12 col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<form name="edit-seminar" id="edit-seminar" role="form" action="<?php echo URL::site('conference/update_seminar'); ?>" method="post">
							...
							<div class="panel-body">
								<div id="form-body">
									<div class="form-group">
										...
										<input type="text" class="form-control required" id="conf-name" placeholder="Enter the title of the talk" name="Conference[name]" value="<?php if(isset($conference_name) && !empty($conference_name)) echo $conference_name; ?>"/>	
									</div>
									...
									<div class="form-group">
										...
										<div class="form-inline">
											<div class="form-group">
												<input type="text" class="form-control datepicker required" id="start-date" placeholder="" name="Conference[start_date]" data-date-format="dd/mm/yyyy"  value="<?php if(isset($start_date) && !empty($start_date)) echo $start_date; ?>"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label>Speaker</label>
										<input type="text" class="form-control required" name="Seminar[speaker]" value="<?php if(isset($speaker) && !empty($speaker)) echo $speaker; ?>">
									</div>

									<div class="form-group">
										<label>Abstract</label>
										<textarea class="form-control" rows="4" name="Seminar[abstract]"><?php if(isset($abstract) && !empty($abstract)) echo $abstract; ?></textarea>
									</div>

									<div class="form-group">
										<label>Description</label>
										<textarea class="form-control" rows="4" placeholder="What your seminar is about?" name="Conference[description]"><?php if(isset($description) && !empty($description)) echo $description; ?></textarea>
									</div>
									...
									<div class="form-group">
										<label>Website</label>
										<input type="text" class="form-control" id="website" placeholder="URL of the seminar website" name="Conference[website]" value="<?php if(isset($website) && !empty($website)) echo $website; ?>"/>
									</div>
						...
						<input type="hidden" name="Conference[id]" value="<? if(isset($seminar_id) && !empty($seminar_id)) echo $seminar_id; else echo "-1"; ?>" />
...
<?php echo HTML::script('js/edit_seminar.js') ?>
