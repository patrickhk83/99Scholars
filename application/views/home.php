                ...
                <div id="conf-list">
	                ...
	                <?php foreach ($conferences as $conf): ?>
                        ...
                        <h6>118 Attending</h6>
  		              	...
  		              	<div class="col-md-2"><button type="button" class="btn btn-<?php echo $conf['type_style'] ?> btn-xs"><?php echo $conf['type'] ?></button></div>
  		              	<div class="col-md-2 pad0"><?php echo $conf['duration'] ?></div>
  		              	<div class="col-md-2">
