              ...
              <p>
                <table class="table">
                  <tr>
                    ...
                    <td>
                      <p><a href="#"><strong>Mark Otto</strong></a> <small class="text-muted">Massachusetts Institute of Technology</small></p>
                  ...
                  <tr>
                    <td width="60px"><?php echo HTML::image('img/avatar.jpg') ?></td>
                    <td>
                      <p><a href="#"><strong>Jacob Thornton</strong></a> <small class="text-muted">Queen's University</small></p>
                  ...
                  <tr>
                    <td width="60px"><?php echo HTML::image('img/avatar.jpg') ?></td>
                    <td>
                      <p><a href="#"><strong>Larry Bird</strong></a> <small class="text-muted">University of California, Los Angeles</small></p>
              ...
              <p>
                <table class="table">
                  <tr>
                    ...
                    <td>
                      <p><a href="#"><strong>Mark Otto</strong></a> <br/> <small class="text-muted">Massachusetts Institute of Technology</small></p>
                      <p></p>
                    </td>
                  </tr>
                  <tr>
                  	<td width="40px"><?php echo HTML::image('img/avatar.jpg', array('width'  => '40')) ?></td>
                    <td>
                      <p><a href="#"><strong>Jacob Thornton</strong></a> <br/> <small class="text-muted">Queen's University</small></p>
                      <p></p>
                    </td>
                  </tr>
                  <tr>
                  	<td width="40px"><?php echo HTML::image('img/avatar.jpg', array('width'  => '40')) ?></td>
                    <td>
                      <p><a href="#"><strong>Larry Bird</strong></a> <br/> <small class="text-muted">University of California, Los Angeles</small></p>
                      <p></p>
                    </td>
                  </tr>
                </table>
