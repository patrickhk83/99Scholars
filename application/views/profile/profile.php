              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <ul class="nav nav-tabs" id="profile-tab">
                    ...
                    <li><a href="#following" data-toggle="tab" id="following-link">Followings (<?= $info['following'] ?>)</a></li>
                    <li><a href="#follower" data-toggle="tab" id="follower-link">Followers (<?= $info['follower'] ?>)</a></li>
                  </ul>
