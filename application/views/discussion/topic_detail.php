      ...
      <?php if(isset($topic['comments'])) { ?>
        <?php foreach($topic['comments'] as $comment) { ?>
          <tr>
            <td width="60px"><?php echo HTML::image('img/avatar.jpg') ?></td>
            <td>
              <p><a href="<?php echo URL::site('user/profile/'.$comment['author_id']) ?>"><strong><?php echo $commnet['author_name'] ?></strong></a> <small class="text-muted">Massachusetts Institute of Technology</small></p>
